...
public interface Constants {
  public static final class DriveConstants {
    ...
    public static final double kTrackwidthMeters = 0.6400;//Working Well: 0.6729;
    ...
    public static final double ksVolts = 2.33; // Working well 10X characterized constant 1.29;
    public static final double kvVoltSecondsPerMeter = 53.6; // Working well 10X characterized constant 50.8;
    public static final double kaVoltSecondsSquaredPerMeter = 0.0526; // Working well 10X charachterized constant 4.54;
    ...
    public static final double kPDriveVel = 0.00000000739;//Working Well: 14.2;
